...
namespace WebPortal.Controllers
{
    ...
    public class InvoiceByMonthController : Controller
    {
        ...
        private List<view_InvoiceByMonth> ApplyFilter(string search, int searchId, DateTime fromDate, DateTime toDate, bool txtCon, bool datCon, out bool filter)
        {
            filter = true;
            var dbAccess = _db.view_InvoiceByMonth;
            List<view_InvoiceByMonth> model = new List<view_InvoiceByMonth>();
            if (datCon && !txtCon)
            {
