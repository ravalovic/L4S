...
for %%A in (.\??_create_view*.sql) do (%SQLRUN% -S "winbz.bluez.biz" -U l4sowner -P "0wNer,123" -i %%A)
for %%A in (.\??_create_sp*.sql) do (%SQLRUN% -S "winbz.bluez.biz" -U l4sowner -P "0wNer,123" -i %%A)
