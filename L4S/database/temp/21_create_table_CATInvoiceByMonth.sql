...
/****** Object:  Table [dbo].[CATInvoiceByMonth]    Script Date: 09.09.2017 0:25:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[CATInvoiceByMonth](
	[ID] [int] NOT NULL,
 ...
 CONSTRAINT [PK_dbo.CATInvoiceByMonth] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
ALTER TABLE [dbo].[CATInvoiceByMonth] ADD  CONSTRAINT [DF_dbo.CATInvoiceByMonth_TCInsertTime]  DEFAULT (getdate()) FOR [TCInsertTime]
GO

ALTER TABLE [dbo].[CATInvoiceByMonth] ADD  CONSTRAINT [DF_dbo.CATInvoiceByMonth_TCLastUpdate]  DEFAULT (getdate()) FOR [TCLastUpdate]
GO

ALTER TABLE [dbo].[CATInvoiceByMonth] ADD  CONSTRAINT [DF_dbo.CATInvoiceByMonth_TCActive]  DEFAULT ((0)) FOR [TCActive]
GO
